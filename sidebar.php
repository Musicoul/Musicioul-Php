       ...
       <div class="aui-sidebar">
            <div class="aui-sidebar-wrapper">
                        ...
                        <div class="aui-page-header-inner">
                            ...
                            <div class="aui-page-header-main">
                                ...
                                <ol class="aui-nav aui-nav-breadcrumbs">
                                    <li>
                                        <a href="#"><span class="aui-nav-item-label">This is a really really long title
                                                for whatever this is</span></a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="aui-sidebar-footer">
                    <a href="https://example.com" class="aui-button aui-button-subtle aui-sidebar-settings-button"
                        title="Settings">
